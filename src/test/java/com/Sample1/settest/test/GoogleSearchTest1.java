...
public class GoogleSearchTest1 {
  ...
  private boolean isElementPresent(By by) {
    try {
      ...
      return false;
    }//used for hcecking elements is their or not
  }
  ...
  private boolean isAlertPresent() {
    try {
      ...
      return false;
    }//let you know that is their any alert or not
  }
  ...
  }//used for closing that alert.using only try and catch optionnor switch to case.
}
